...
$mail->addAddress('leonprasetya1@gmail.com', 'Leon');
//Set the subject line
$mail->Subject = 'Lupa Password';
//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body
$mail->msgHTML(file_get_contents('register.php'), __DIR__);
//Replace the plain text body with one created manually
//$mail->IsHTML(true);
//$mail->Body = "http://localhost";
//$mail->Body = 'username : '.$username.' password : '.$password.'<br> http://localhost';
